...
GENERATORS = {
    ...
    "MolCRAFT": {
        "risk": "results/molcraft_crossdock_t50_n16_risk_scores.csv",
        "dock": "results/molcraft_crossdock_t50_n16_dockfast_selection_summary.csv",
        "gnina": "results/molcraft_crossdock_t50_n16_gnina_score_top1_summary.csv",
        "vina": "results/molcraft_crossdock_t50_n16_vina_redock_top1_summary.csv",
        "aizynth": "results/aizynthfinder_molcraft_top1_summary.csv",
        "policies": {"pb_qed": "PB-QED", "pb_rc_select": "PB-RC"},
    },
    "MolPilot-framefix": {
...
def main():
    ...
    lines = [
        ...
        "- Common evidence: RC risk, PoseBusters dock_fast, GNINA score-only top-1, Vina redocking top-1, and AiZynthFinder top-1 retrosynthesis.",
    ...
    lines.extend(
        [
            ...
            "## Findings",
            "",
            "1. MolCRAFT provides a strong positive SOTA generator: PB-RC preserves GNINA/Vina/AiZynth evidence while eliminating high-risk selected poses.",
